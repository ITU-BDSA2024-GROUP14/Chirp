...
[^2]: Pushing secrets like these to a public github repo are a bad idea. They are added here to make it easier to run the program, without having to create your own github oauth token, and the program _Chirp!_ is not of the importance where this is a problem. 
